...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            Server modOperador = new Server(properties.get("IP"), properties.get("PORT1"), properties.get("SERVICE1"), serviceOperador);

            ServiceRegistro serviceRegistro = new ServiceRegistro(new ControllerRegistro());
            Server modRegistgro = new Server(properties.get("IP"), properties.get("PORT1"), properties.get("SERVICE1"), serviceRegistro);
